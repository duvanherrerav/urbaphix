...
-- It is idempotent and does not modify application data, tables, columns,
-- foreign keys, secrets, or historical migrations.
--
-- Source baseline:
-- 20260723120000_promote_canonical_qa_prd_function_rls.sql
