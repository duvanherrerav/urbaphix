...
- **Riesgo:** bajo-medio, corrige ambigüedad de `conjunto_id` en agregados Superadmin antes de promover el candidato QA.
...
2. Aplicar solo a QA, en orden cronológico, sin PRD, incluyendo como último paso el hotfix `20260715120000_hotfix_qa_fn_platform_tenants_summary_qualified_conjunto_id.sql`.
