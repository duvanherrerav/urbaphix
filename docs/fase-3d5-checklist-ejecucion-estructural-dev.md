...
| Helpers legacy y tenant-aware | SQL principal sección 03 | Pendiente | Pendiente |
...
| Policies amplias o sin filtro visible tenant/residente | SQL complementario secciones 09 y 12 | Pendiente | Pendiente |
...
| P1 | ¿Existen policies amplias, helpers legacy sensibles, duplicidades activas o residentes sin trazabilidad clara? | Pendiente |
...
| Helpers usados por RLS identificados | Pendiente | Pendiente |
