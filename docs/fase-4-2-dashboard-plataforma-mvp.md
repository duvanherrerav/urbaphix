...
- Consume métricas agregadas con sesión autenticada Supabase desde frontend, sin `service_role`.
- No agrega CRUD, migraciones SQL, tablas, columnas, FKs ni políticas RLS.
